...
If you discover a security vulnerability in DevContext, please report it responsibly:
...
DevContext handles sensitive data including:
...
- Never commit `.env` files or tokens to your DevContext workspace.
- Use fine-grained GitHub Personal Access Tokens with minimal scopes.
- Keep DevContext updated to the latest version.
